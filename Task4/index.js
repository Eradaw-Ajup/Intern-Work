function init() {
    ...
    $(go.Node, "Spot",
      {
        ...
        mouseDrop: (e, node) => {
          ...
          if (node.data.allowedChildren > 0){
        ...
        $(go.Panel, "Horizontal",
          ...
          $(go.Panel, "Table",
            ...
            $(go.TextBlock, textStyle(),  // the comments
              ...
              $(go.TextBlock, textStyle(),
                { row: 3, column: 0 },
                new go.Binding("text", "allowedChildren", v => "Allowed children: " + v)),
  ...
  function addEmployee(node) {
    ...
    if (node.data.allowedChildren > 0){
        ...
        const newemp = { name: "(new person)", title: "(title)", comments: "", parent: thisemp.key , allowedChildren: 2, pic: ""};
        ...
        $(go.TextBlock, "Vacate Position"),
        {
          click: (e, button) => {
            ...
            if (node !== null) {
              ...
              myDiagram.model.setDataProperty(thisemp, "allowedChildren", 2);
